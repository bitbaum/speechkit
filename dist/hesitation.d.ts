...
export declare const MAX_HESITATIONS = 3;
...
export declare function hesitations(pauses: readonly PauseSpan[], words: readonly TimedWord[], limit?: number): Hesitation[];
//# sourceMappingURL=hesitation.d.ts.map