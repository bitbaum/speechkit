...
export const NATION_LADDER = [240, 180, 120];
/**
...
const PAUSE_NOISE = 2;
function trendOf(first, last, noise) {
    if (last > first + noise)
        return "rose";
    if (last < first - noise)
        return "fell";
 ...
 */
export function trajectory(attempts, ladder) {
 ...
 * is finished.
 */
export function nextLimit(done, ladder) {
