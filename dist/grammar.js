 ...
 */
export const SPOKEN_CATEGORIES = [
    "GRAMMAR",
    "AGREEMENT",
    "CONFUSED_WORDS",
    "VERBS",
 ...
 */
export const SPOKEN_EXEMPT_RULES = [
 ...
 * the whole check.
 */
export function fromLanguageTool(body, transcript, options = {}) {
...
export function worthShowing(findings, limit = MAX_SHOWN) {
