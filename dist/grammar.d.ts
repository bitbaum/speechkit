 ...
 */
export declare const SPOKEN_CATEGORIES: readonly string[];
/**
 ...
 */
export declare const SPOKEN_EXEMPT_RULES: readonly string[];
/**
 ...
 * the whole check.
 */
export declare function fromLanguageTool(body: unknown, transcript: string, options?: {
 ...
 */
export declare const MAX_SHOWN = 3;
export declare function worthShowing(findings: readonly GrammarFinding[], limit?: number): GrammarFinding[];
