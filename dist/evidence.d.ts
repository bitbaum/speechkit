 ...
 */
export declare const FORM_JUDGEMENT_MAX_WER = 15;
export declare function evidenceFrom(recognition: Recognition): EvidenceKind;
/**
 ...
 */
export declare function mayJudgeForm(recognition: Recognition): boolean;
/**
 ...
 */
export declare function isFaithfulRendering(recognition: Recognition): boolean;
